...
function gameLoop() {
  ...
  if (respBox == correctResp) {
    ...
    numberBoxes[1].innerHTML = wrong;
    numberBoxes[2].innerHTML = percent;
    cofa.innerHTML = 'Incorrect, correct answer is: ' + correctResp;
    cofa.style.visibility = 'visible';
    // Check Box Incorreto
    submit.disabled = true;
  }
...
submit.addEventListener('click', function () {
  var x = pegaBox();
  if (x.length === 0) {
    cofa.innerHTML = 'Please select an answer option.';
    cofa.style.visibility = 'visible';
    submit.disabled = true;
    setTimeout(function () {
      cofa.style.visibility = 'hidden';
    ...
    cofa.innerHTML = 'Please select only one answer option.';
    cofa.style.visibility = 'visible';
    submit.disabled = true;
    setTimeout(function () {
      cofa.style.visibility = 'hidden';
